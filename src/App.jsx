    ...
    <main className="border-2 border-orange min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a className="font-lexend bg-offwhitebg block px-10 py-3 w-fit rounded-3xl text-dark-green" href="https://www.webmotors.com.br/carros-de-luxo/carros/" target="_blank">ver mais</a>
        </div>
